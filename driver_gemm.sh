...
NROWS=4 NCOLS=2 BLOCK_SIZE=256 NUM_BLOCKS=16  sbatch --output=${name} -c 32 -n 8 run_gemm_2d.sh
NROWS=4 NCOLS=2 BLOCK_SIZE=256 NUM_BLOCKS=32  sbatch --output=${name} -c 32 -n 8 run_gemm_2d.sh
NROWS=4 NCOLS=2 BLOCK_SIZE=256 NUM_BLOCKS=64  sbatch --output=${name} -c 32 -n 8 run_gemm_2d.sh
NROWS=4 NCOLS=2 BLOCK_SIZE=256 NUM_BLOCKS=128 sbatch --output=${name} -c 32 -n 8 run_gemm_2d.sh
